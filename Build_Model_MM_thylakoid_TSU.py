...
def printout(V, Stats, model, id='all'):
    ...
    processResults(model.reactions, V, Vin, Pin, model.Pout, id)

def processResults(reactions, V, Vin, Pin, Pout, id):
    import pandas
...
trainname = "plastidial_model_duplicated_restricted_media_noATP_UB_2_athaliana_TSU_ZT9_thylakoid"
...
sTime = time.time()
id = 'athaliana_TSU_ZT9_thylakoid'
